...
export const SUBJECTS: SubjectItem[] = [
  // 1. 8.5 x 11 Inches to Pixels
  {
    ...
    metaDesc: 'Convert 8.5 x 11 inches to pixels at 72, 96, 150, 300, and 600 DPI. Pre-computed pixel dimensions for standard US Letter documents, flyers, and print press.',
  ...
  // 7. How Many Pixels in an Inch?
  {
    ...
    metaDesc: 'Discover how many pixels are in an inch across web (96 DPI), print (300 DPI), and legacy screens (72 DPI). Includes Device Pixel Ratio (DPR) guide.',
  ...
  // 9. How to Change Pixels to Inches in Photoshop
  {
    ...
    metaDesc: 'Step-by-step guide to convert pixels to inches in Adobe Photoshop. Learn to use Image Size, adjust Resolution (DPI), toggle Resample, and set Rulers.',
